...
////////////////////////////////////////////////////////////////////////////////
input_type input::type() const
{
    return data_.get().type;
}

////////////////////////////////////////////////////////////////////////////////
input_port input::port() const
{
    return data_.get().port;
}
...
////////////////////////////////////////////////////////////////////////////////
void input::pgm_on(me_num me)
{
    sess_.get().set_pgm(me, id());
}

////////////////////////////////////////////////////////////////////////////////
void input::pgm_on(const atem::me& me)
{
    pgm_on(me.num());
}

////////////////////////////////////////////////////////////////////////////////
void input::pvw_on(me_num me)
{
    sess_.get().set_pvw(me, id());
}

////////////////////////////////////////////////////////////////////////////////
void input::pvw_on(const atem::me& me)
{
    pvw_on(me.num());
}
